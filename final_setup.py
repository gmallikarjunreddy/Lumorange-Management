...
try:
    ...
    if dept_count == 0:
        ...
        sample_departments = [
            ...
            ('HR Department', 'Human Resources and People Management'),
            ('Finance Department', 'Financial Management and Accounting'),
            ('Marketing Department', 'Marketing and Business Development')
        ]
        
        insert_sql = '''INSERT INTO departments (name, description) VALUES (%s, %s)'''
        cursor.executemany(insert_sql, sample_departments)
        conn.commit()
    ...
    if employee_count == 0:
        ...
        sample_employees = [
            ...
            ('EMP002', 'Priya Sharma', 'Priya', 'Sharma', 'priya@lumorange.com', '9876543211', 'Developer', 1, 'active'),
            ('EMP003', 'Amit Singh', 'Amit', 'Singh', 'amit@lumorange.com', '9876543212', 'Analyst', 2, 'active'),
            ('EMP004', 'Neha Gupta', 'Neha', 'Gupta', 'neha@lumorange.com', '9876543213', 'Designer', 3, 'active')
        ]
