...
try:
    ...
    if employee_count == 0:
        ...
        sample_employees = [
            ('EMP001', 'Rajesh', 'Kumar', 'rajesh@lumorange.com', '9876543210', 'Manager', 1, 'active'),
            ('EMP002', 'Priya', 'Sharma', 'priya@lumorange.com', '9876543211', 'Developer', 2, 'active'),
            ('EMP003', 'Amit', 'Singh', 'amit@lumorange.com', '9876543212', 'Analyst', 3, 'active'),
            ('EMP004', 'Neha', 'Gupta', 'neha@lumorange.com', '9876543213', 'Designer', 1, 'active')
        ]
        
        insert_sql = '''INSERT INTO employees 
                        (employee_id, first_name, last_name, email, phone, position, department_id, status) 
